...
class CandelaConfigurable(private val project: Project) : Configurable {
    ...
    override fun createComponent(): JComponent {
        ...
        return FormBuilder.createFormBuilder()
            .addLabeledComponent(JBLabel("Path to ${CandelaLspBinary.NAME}:"), serverPath, 1, false)
    ...
    override fun isModified(): Boolean {
        val state = CandelaSettings.getInstance(project).state
